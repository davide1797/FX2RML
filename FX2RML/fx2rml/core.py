...
def fx2rml(mapping_files, tabular_files, output_file, output_format="ttl"):
    """
    ...
    for source_index in range(0, len(mapping_files)):
        mapping_file = mapping_files[source_index]
        tabular_file = tabular_files[source_index]
    ...
    g.serialize(output_file, output_format)
...
def main():
    ...
    g = fx2rml(args.mappings, args.inputs, args.output, output_format)     # Call FX2RML function with parsed arguments
    #print_graph(g)
...
def mymain():
    ...
    #tabular_files = ["/home/depierro/Desktop/INRAe/ISWC 2025/FX2RML/tests/Electric Vehicles/electric vehicles.csv"]
    #output_file = "/home/depierro/Desktop/INRAe/ISWC 2025/FX2RML/tests/Electric Vehicles/electric vehicles.ttl"
    ...
    #tabular_files = ["/home/depierro/Desktop/INRAe/ISWC 2025/FX2RML/tests/PFAS/pfas_1.csv", "/home/depierro/Desktop/INRAe/ISWC 2025/FX2RML/tests/PFAS/matrix.csv"]
